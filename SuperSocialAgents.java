...
public class SuperSocialAgents extends Agent{
    boolean moved;
    int R;
   

    public SuperSocialAgents(double x0, double y0, int radius) {
        super( x0, y0 );
        R = radius;
    }
    ...
    public void draw(Graphics g){
        ...
        else g.setColor(new Color(50, 168, 82));
    ...
    public void updateState(Landscape scape){
        ...
        int numNeighbors = scape.extensionGetNeighbors(xPos, yPos, R).size();
